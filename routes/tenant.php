...
| These routes are loaded by the TenancyServiceProvider and will only
| be accessible on tenant domains (e.g., schoolname.school-ms.com).
|
| All your school management functionality goes here.
|
*/
...
Route::middleware([
    ...
    // Fallback route for 404 (within tenant context)
