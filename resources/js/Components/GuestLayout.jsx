        ...
        <div className="min-h-screen flex flex-col lg:flex-row">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0b1a34] via-[#1e3a5f] to-[#0b1a34] relative overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                    ...
                    <div
                        className="absolute bottom-0 right-0 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
                ...
                <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
                    <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl mb-8">
                        <School className="w-20 h-20 text-orange-500" />
                    </div>
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                        School Management System
                    </h1>
                    <p className="text-base md:text-xl text-gray-300 text-center max-w-md mb-12">
                    ...
                    <div className="grid grid-cols-3 gap-6 text-center">
                        ...
                        <div>
                            ...
                            <div className="text-sm md:text-base text-gray-300">Teachers</div>
                        </div>
                        <div>
                            <div className="text-3xl md:text-4xl font-bold text-orange-500 mb-1">15+</div>
                            <div className="text-sm md:text-base text-gray-300">Grades</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-12 py-12">
