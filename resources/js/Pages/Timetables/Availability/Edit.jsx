...
export default function EditAvailability({ availability, teachers, auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('timetables.availability.update', availability.id));
    };
    ...
    return (
        <AuthenticatedLayout header="Edit Availability">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Update availability settings</p>
                        </div>
                    </div>
                    <Link
