...
export default function EditRoom({ room, auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('timetables.rooms.update', room.id));
    };
    ...
    return (
        <AuthenticatedLayout header="Edit Room">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Update room: {room.code}</p>
                        </div>
                    </div>
                    <Link
