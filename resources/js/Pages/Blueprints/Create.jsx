...
export default function BlueprintsCreate({ auth, levels, periodTypes, priorityBands }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        description: '',
        periods: [
            { period_type: 'lesson', duration_minutes: 40, priority_band: 'morning_high' }
        ],
    });
            ...
            <div className="py-6 sm:py-8">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-navy">Create Day Blueprint</h1>
                        <p className="mt-1 text-sm text-gray-600">
                            Define the daily schedule structure for a school level
                        </p>
                    </div>
