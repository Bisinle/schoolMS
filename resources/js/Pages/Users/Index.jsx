...
function MobileUserItem({
    ...
    const primaryActions = [
        { icon: Eye, label: "View", href: `/users/${user.id}` },
        {
            icon: Edit,
            label: "Edit",
    ...
    const header = (
        <div className="flex gap-3">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="mb-2">
                    <span
                        className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold ${roleColors.icon} ${roleColors.iconColor} border ${roleColors.border}`}
                    >
    ...
    return (
        ...
        >
            <ExpandableCard header={header}>{expandedContent}</ExpandableCard>
        </SwipeableListItem>
    );
}
                ...
                <div className="space-y-3">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <p className="text-sm text-yellow-800">
                            ⚠️ You will see the system exactly as this user sees
                            it. A purple banner will appear at the top allowing
                            you to exit back to admin mode.
                        </p>
                    </div>
                </div>
            ),
