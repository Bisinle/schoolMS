...
export default function Edit({ category, entityTypes }) {
    const { data, setData, put, processing, errors } = useForm({
        name: category.name || "",
        entity_type: category.entity_type || "",
        is_required: category.is_required || false,
        description: category.description || "",
        max_file_size: category.max_file_size || 10240,
        allowed_extensions: category.allowed_extensions || [],
        expires: category.expires || false,
        expiry_alert_days: category.expiry_alert_days || 30,
    ...
    return (
        <AuthenticatedLayout header="Edit Document Category">
                        ...
                        <div className="border-t border-gray-200 pt-6">
                            <div className="flex items-start mb-4">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Enable if documents have expiry dates.
                                    </p>
                                </div>
                            </div>
                            ...
                            {data.expires && (
                                <div className="ml-7">
                                    ...
                                    />
                                    <p className="mt-1 text-sm text-gray-500">
                                        Send alert X days before expiry.
                                    </p>
                                </div>
                            )}
                        </div>
